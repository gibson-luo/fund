...
public class MaximumLoadsPerDayRuleTests {
    ...
    void test_Maximum_Loads_Per_Day_Rule(String limit, int loadTimesOfDay, boolean expected){
        // set up
        customerData.setLoadTimesOfDay(loadTimesOfDay);

        // execute
        MaximumLoadsPerDayRule rule = new MaximumLoadsPerDayRule();
